...
<html lang="id">
    <head>
        ...
        <title>Pelayanan Publik DPRD KOTA TEGAL - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/css/custom-bs.css')); ?>"
        />
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/css/jquery.fancybox.min.css')); ?>"
        />
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/css/bootstrap-select.min.css')); ?>"
        />
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/fonts/icomoon/style.css')); ?>"
        />
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/fonts/line-icons/style.css')); ?>"
        />
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/css/owl.carousel.min.css')); ?>"
        />
        <link
            rel="stylesheet"
            href="<?php echo e(asset('frontend/css/animate.min.css')); ?>"
        />
                        ...
                        <ul class="navbar-nav mx-auto align-items-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                >
                                    ...
                                    <a
                                        class="dropdown-item"
                                        href="<?php echo e(route('sekretariat')); ?>"
                                        >Sekretariat</a
                                    >
                                    <a
                                        class="dropdown-item"
                                        href="<?php echo e(route('anggota.showAnggota')); ?>"
                                    >
                                        Pimpinan Dewan DPRD Kota Tegal
                                    </a>
                                    <a
                                        class="dropdown-item"
                                        href="<?php echo e(route('aspirasi.create')); ?>"
                                        >Aspirasi</a
                                    >
                                    <a
                                        class="dropdown-item"
                                        href="<?php echo e(route('magang.lowongan')); ?>"
                                        >Lowongan Magang</a
                                    >
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a
                                    class="nav-link"
                                    href="<?php echo e(route('pemberitahuan')); ?>"
                                    >Pemberitahuan</a
                                >
                            </li>
                        </ul>
...
<?php /**PATH D:\penting\pelayanan_publik_dprd\pelayanan_publik_dprd\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>