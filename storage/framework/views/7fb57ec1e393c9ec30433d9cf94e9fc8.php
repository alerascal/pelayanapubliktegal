<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <div class="sidebar-brand text-center mt-2">
            <a href="<?php echo e(url('/')); ?>" class="text-primary font-weight-bold">
                DPRD Kota Tegal
            </a>
        </div>
        <!-- Brand Mini -->
        ...
        <ul class="sidebar-menu mt-4">
            ...
            <li class="<?php echo e(Request::is('backend/berita*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('berita.index')); ?>">
                    <i class="fas fa-newspaper"></i> <span>Berita</span>
                </a>
            </li>

            <li class="<?php echo e(Request::is('backend/anggota*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('anggota.index')); ?>">
                    <i class="fas fa-users"></i> <span>Anggota Dewan</span>
                </a>
            </li>

            <li class="<?php echo e(Request::is('backend/magang*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('magang.index')); ?>">
            ...
            ?>
            <li class="<?php echo e(Request::is('backend/magang/pendaftar/*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('magang.pendaftar', ['id' => $idLowongan])); ?>">
                    <i class="fas fa-user-check"></i> <span>Pendaftar Magang</span>
                </a>
            </li>

            <li class="<?php echo e(Request::is('backend/users*') ? 'active' : ''); ?>">
            ...
            <li class="<?php echo e(Request::is('backend/aspirasi') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('aspirasi.index')); ?>">
                    <i class="fas fa-comments"></i> <span>Data Aspirasi</span>
                </a>
            </li>

            <li class="<?php echo e(Request::is('backend/aspirasi/arsip') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('aspirasi.arsip')); ?>">
                    <i class="fas fa-archive"></i> <span>Arsip Aspirasi</span>
                </a>
            </li>

            <li class="<?php echo e(request()->routeIs('laporan.index') ? 'active' : ''); ?>">
...
<?php /**PATH D:\penting\pelayanan_publik_dprd\pelayanan_publik_dprd\resources\views/components/sidebar.blade.php ENDPATH**/ ?>