            ...
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white d-flex align-items-center">
                <div class="w-100 p-4">
                    <div class="text-center mb-4">
                        <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="logo" width="80" class="mb-3">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate="">
                        ...
                        <div class="form-group text-right">
                            <a href="<?php echo e(route('password.request')); ?>" class="text-small text-primary">Lupa Password?</a>
                        </div>
                        ...
                        <div class="form-group text-center mt-4">
                            <a href="<?php echo e(route('register')); ?>" class="text-muted">Belum punya akun? <strong>Daftar di sini</strong></a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH D:\penting\pelayanan_publik_dprd\pelayanan_publik_dprd\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>