...
<?php $__env->startSection('title', 'Sejarah DPRD Kota Tegal'); ?>
<?php $__env->startSection('content'); ?>

<section class="home-section section-hero overlay bg-image animate__animated animate__fadeIn" 
         style="background-image: linear-gradient(rgba(0, 51, 102, 0.7), rgba(0, 0, 0, 0.6)), url('<?php echo e(asset('frontend/images/hero_1.jpg')); ?>'); background-size: cover; background-position: center; position: relative; padding: 150px 0;" 
         id="home-section">
  <div class="container">
  ...
  <div class="container" id="sekretariat">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        ...
        <?php $__currentLoopData = $sejarah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-md-12 mb-4">
            <a href="#" class="block__16443 d-flex align-items-start text-decoration-none bg-white p-4 rounded-lg shadow-md animate__animated animate__fadeInUp animate__delay-<?php echo e($index); ?>s"
              ...
              <p class="mb-0 text-dark text-justify" style="font-weight: 500; font-size: 1.15rem;"><?php echo e($item); ?></p>
            </a>
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\penting\pelayanan_publik_dprd\pelayanan_publik_dprd\resources\views/pages/frontend/sejarah.blade.php ENDPATH**/ ?>