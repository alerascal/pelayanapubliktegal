                ...
                <div class="login-container w-100">
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>" class="needs-validation" novalidate="">
                        ...
                        <div class="form-group text-center mt-4">
                            <a href="<?php echo e(route('login')); ?>" class="text-muted"><i class="fas fa-chevron-left mr-1"></i> Kembali ke login</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH D:\penting\pelayanan_publik_dprd\pelayanan_publik_dprd\resources\views/pages/auth/forgot-password.blade.php ENDPATH**/ ?>