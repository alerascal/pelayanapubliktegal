...
<?php $__env->startSection('title', 'Tambah Anggota Dewan'); ?>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <form action="<?php echo e(route('anggota.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Fraksi</label>
                                <input type="text" name="fraksi" class="form-control" value="<?php echo e(old('fraksi')); ?>">
                            </div>
                            ...
                            <?php $sosmedList = ['Facebook', 'Instagram', 'TikTok', 'Twitter']; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="sosmed[<?php echo e(strtolower($sosmed)); ?>]" class="form-control" value="<?php echo e(old('sosmed.' . strtolower($sosmed))); ?>" placeholder="https://<?php echo e(strtolower($sosmed)); ?>.com/namauser (opsional)">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="bio_latar" class="form-control" rows="3"><?php echo e(old('bio_latar')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Perjalanan Karier</label>
                                <textarea name="bio_karier" class="form-control" rows="3"><?php echo e(old('bio_karier')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Jabatan & Penghargaan</label>
                                <textarea name="bio_jabatan" class="form-control" rows="3"><?php echo e(old('bio_jabatan')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Visi dan Motivasi</label>
                                <textarea name="bio_visi" class="form-control" rows="3"><?php echo e(old('bio_visi')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Fokus Perjuangan</label>
                                <textarea name="bio_fokus" class="form-control" rows="3"><?php echo e(old('bio_fokus')); ?></textarea>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\penting\pelayanan_publik_dprd\pelayanan_publik_dprd\resources\views/pages/backend/anggota_dewan/create.blade.php ENDPATH**/ ?>