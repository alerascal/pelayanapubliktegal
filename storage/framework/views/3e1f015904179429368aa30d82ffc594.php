...
<body>
    <div class="email-container">
        <div class="email-body">
            ...
            <p>Kami menerima permintaan untuk mereset password akun Anda yang terdaftar dengan alamat email <strong><?php echo e($user->email); ?></strong>.</p>
            ...
            <p>Link reset password ini hanya berlaku selama <strong>60 menit</strong>. Setelah itu, Anda perlu meminta ulang jika masih membutuhkan reset.</p>

            <p>Jika Anda tidak pernah meminta reset password, Anda dapat mengabaikan email ini. Tidak ada perubahan yang akan dilakukan pada akun Anda.</p>
