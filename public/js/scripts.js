...
if (window.Chart) {
  ...
  Chart.defaults.font.style = 'normal'; // Gaya font yang valid
  Chart.defaults.font.weight = 500;     // Berat font
  ...
  Chart.defaults.plugins.tooltip.titleFont = { size: 14, family: "'Nunito', 'Segoe UI', 'Arial'", color: '#fff', weight: 500 };
