...
<section class="home-section section-hero overlay bg-image animate__animated animate__fadeIn" 
         style="background: linear-gradient(135deg, rgba(0, 51, 102, 0.7), rgba(0, 0, 0, 0.6)), url('{{ asset('frontend/images/magang.jpg') }}'); background-size: cover; background-position: center; min-height: 60vh; display: flex; align-items: center; justify-content: center; position: relative; overflow: hidden;">
    <div class="container">
        ...
        <div class="row g-4">
            @forelse ($lowongan as $index => $lowongan)
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card h-100 shadow-sm border-0 card-lowongan animate__animated animate__fadeInUp animate__delay-{{ $index * 0.2 }}s" 
                        ...
                        <div class="card-body d-flex flex-column" style="padding: 25px;">
                            ...
                            <p style="font-size: clamp(0.9rem, 1.8vw, 1rem);"><strong>Kuota:</strong> {{ $lowongan->kuota }} peserta</p>
                            <p style="font-size: clamp(0.9rem, 1.8vw, 1rem);"><strong>Deadline:</strong> {{ $deadline->translatedFormat('d F Y') }}</p>
                            <p style="font-size: clamp(0.9rem, 1.8vw, 1rem);"><strong>Periode:</strong> {{ $lowongan->periode }}</p>
                            ...
                            @else
                                <a href="{{ route('magang.form', ['id' => $lowongan->id]) }}" 
