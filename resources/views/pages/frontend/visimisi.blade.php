...
<section class="home-section section-hero overlay bg-image animate__animated animate__fadeIn" 
         style="background: linear-gradient(rgba(0, 51, 102, 0.7), rgba(0, 0, 0, 0.6)), url('{{ asset('frontend/images/hero_1.jpg') }}'); background-size: cover; background-position: center; position: relative; padding: 150px 0;" 
         id="home-section">
  <div class="container">
        ...
        <div>
          ...
          <ul class="list-unstyled pl-3" style="color: #333; font-size: clamp(1rem, 2vw, 1.1rem); line-height: 1.75;">
            ...
            @foreach($misi as $index => $item)
              <li class="mb-3 d-flex align-items-start animate__animated animate__fadeInUp animate__delay-{{ $index + 1 }}s">
