...
<div class="main-content">
    ...
    <div class="col-md-6 mb-4">
        ...
        {{-- Komponen Tambahan --}}
        @include('components.dashboard.aspirasi')
        @include('components.dashboard.magang')
...
<script>
    ...
    const aspirasiData = [
        {{ $aspirasiDiterima }},
        {{ $aspirasiDitolak }},
        {{ $aspirasiBelumDiproses->count() }}
    ];

    const magangData = [
        {{ $pendaftarMagangDiterima }},
        {{ $pendaftarMagangDitolak }},
        {{ $pendaftarBelumDiproses->count() }}
    ];

    // Grafik Aspirasi per Bulan
const bulanLabels = @json($bulanLabels);
const aspirasiValues = @json($aspirasiValues);
...
// Grafik Pendaftar Magang per Lowongan
const lowonganLabels = @json($lowonganLabels);
const magangCounts = @json($magangCounts);
