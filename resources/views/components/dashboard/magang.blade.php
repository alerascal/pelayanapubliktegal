        ...
        <div class="table-responsive">
            <div class="table-container">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($pendaftarBelumDiproses as $pendaftar)
                            <tr class="border-bottom">
                                <td class="px-4 py-3 fw-semibold text-dark">
                                    <i class="fas fa-user me-1 text-muted"></i>{{ $pendaftar->nama }}
                                </td>
                                <td>
                                    @php
                                    ...
                                    @endphp
                                    <span class="badge status-badge {{ $badgeClass }} px-3 py-1 rounded-pill fw-semibold">
                                        <i class="{{ $icon }} me-1"></i>{{ ucfirst($status) }}
                                    </span>
                                </td>
                                <td class="text-capitalize">
                                    <i class="fas fa-briefcase me-1 text-muted"></i>
                                    {{ $pendaftar->lowongan->judul ?? 'Tidak Diketahui' }}
                                </td>
